...
# Import cleaned data
trip_text <- read_csv("data/trip_text_cleaned.csv")
wiki_text <- read_csv("data/wiki_text.csv")
...
freq_trip <- colSums(m_trip)
freq_trip <- freq_trip[order(-freq_trip)]
freq_wiki <- colSums(m_wiki)
freq_wiki <- freq_wiki[order(-freq_wiki)]
```
